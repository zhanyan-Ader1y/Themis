# verify/detail.md — 2026-08-19-core-removal / step1
...
grep -c '^### ' .themis/workspace/spec/2026-08-19-core-removal/step1/task/basic.md
grep -c '^### T-D' .themis/workspace/spec/2026-08-19-core-removal/step1/task/detail.md
grep -c '依赖的基础任务\*\*：无' .themis/workspace/spec/2026-08-19-core-removal/step1/task/detail.md
```
...
```bash
grep -n -o '确认权归 R1 评审者' .themis/workspace/spec/2026-08-19-core-removal/Intent.md .themis/workspace/spec/2026-08-19-core-removal/state.md
grep -n '（Q4）' .themis/workspace/spec/2026-08-19-core-removal/QA.md
grep -n '（Q4）' .themis/workspace/spec/2026-08-19-core-removal/QA.md | cat -A
git diff --stat 3b2dde0 HEAD -- .themis/workspace/spec/2026-08-19-core-removal/Intent.md .themis/workspace/spec/2026-08-19-core-removal/QA.md
git diff -U0 3b2dde0 HEAD -- .themis/workspace/spec/2026-08-19-core-removal/state.md | grep -c '确认权归 R1 评审者'
```

```text
.themis/workspace/spec/2026-08-19-core-removal/Intent.md:3:确认权归 R1 评审者
.themis/workspace/spec/2026-08-19-core-removal/state.md:21:确认权归 R1 评审者
19:4.（Q4）确认排除
