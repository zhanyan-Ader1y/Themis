# design.md — 2026-08-19-core-removal / step1
...
真实剩余命中除已识别的 `.gitignore:8`、`templates/.themis/{AGENTS,CLAUDE.themis,README}.md`、`templates/.themis/spec/README.md`、`catalog.md:33`、以及本实例工件自身（`.themis/workspace/spec/2026-08-19-core-removal/**`，属本次生成的记录，不是待处理引用）外，新发现两类命中：
