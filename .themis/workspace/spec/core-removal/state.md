...
impl/detail（**已解锁，前置为 R3 approved**——依据是控制器裁定 Ruling 18，不是控制面条款直接给出的结论，见下）。
...
- impl/detail：未开始 — 无（前置已满足：空段下取 R3 approved，依据是控制器裁定 Ruling 18，见「当前节点」；本节点尚未动手）
- verify/detail：未开始 — 无
- 人工验收：未开始 — 无
- 摘要：未开始 — 无
