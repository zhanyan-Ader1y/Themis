# impl/basic.md — 2026-08-27-claim-command-evidence / step1
...
本节点为空段形态，下一节点结论取 `不适用`（`flow.md`「verify/basic」节）。**本 step 是该取值的第三个使用者**（前两个为 `2026-08-26-workspace-cleanup`、`2026-08-26-authorization-traceability`）。
