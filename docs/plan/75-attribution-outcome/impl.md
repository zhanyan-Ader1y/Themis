...
| Import 接入 | impl-04-orchestrator.md | orchestrator/rules.md 更新 | 将 Attribution 纳入 import 图 |
| 文档同步 | impl-05-docs.md | attribution.md 更新 | WIKI 同步 |
...
| 4 | `templates/.themis/core/kernel/orchestrator/rules.md` | 更新 | impl-04 |
| 5 | `docs/core/kernel/attribution.md` | 更新 | impl-05 |
...
4. **impl-04**（Import 接入）— 依赖 impl-03
...
| V5 | orchestrator/rules.md 含 `@import ../attribution/rules.md` | grep | 存在 |
